      ...
      <div className="container mx-auto px-4 relative z-30">
        <div className="max-w-2xl ml-auto text-right flex flex-col items-end">
          ...
          <div className="flex flex-col sm:flex-row space-y-5 sm:space-y-0 sm:space-x-6 animate-fade-in-up delay-300 justify-end w-full mb-16 items-center">
            {/* CALL BUTTON - MATCHING USER SCREENSHOT */}
            <a 
              href="tel:18882276566" 
              className="group relative flex items-center bg-navy/40 backdrop-blur-xl border border-white/20 px-8 py-4 rounded-full transition-all duration-300 hover:bg-navy/60 hover:border-white/40 shadow-2xl active:scale-95 overflow-hidden"
            >
              {/* Dynamic hover glow */}
              <div className="absolute inset-0 bg-safety-orange/10 opacity-0 group-hover:opacity-100 transition-opacity"></div>
              
              <div className="bg-safety-orange p-3 rounded-2xl shadow-[0_0_20px_rgba(255,133,27,0.4)] group-hover:shadow-[0_0_30px_rgba(255,133,27,0.6)] group-hover:scale-110 transition-all duration-300 mr-5">
                <svg className="w-6 h-6 text-white" fill="currentColor" viewBox="0 0 24 24">
                  <path d="M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z" />
                </svg>
              </div>
              <span className="text-white font-black text-2xl tracking-tight group-hover:text-safety-orange transition-colors">
                1-888-227-6566
              </span>
            </a>
            ...
            <a 
              ...
              className="bg-safety-orange text-white px-10 py-5 rounded-full font-black text-lg shadow-[0_20px_40px_-10px_rgba(255,133,27,0.5)] hover:bg-orange-600 hover:shadow-[0_25px_50px_-10px_rgba(255,133,27,0.6)] transition-all duration-300 flex items-center space-x-3 active:scale-95"
            >
